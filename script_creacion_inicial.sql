...
Marca_Modelo_Marca INT NOT NULL,
Marca_Modelo_Modelo INT NOT NULL,
);
GO
...
Item_Fac_Id_Viaje INT  NOT NULL,
);
GO

CREATE TABLE [DESCONOCIDOS4].CABECERO_RENDICION(
Cab_Rend_Nro NUMERIC(18,0) NOT NULL,
Cab_Rend_Turno INT NOT NULL,
Cab_Rend_Chofer INT NOT NULL,
...
UsuRol_Habilitado BIT DEFAULT 1
);
GO
...
Hoja_Menu_Funcion INT NOT NULL,
Hoja_Menu_Ascendente INT,
);
GO

CREATE TABLE [DESCONOCIDOS4].FUNCIONALIDADXROL(
FuncRol_Rol_Id SMALLINT NOT NULL,
FunRol_Func_Id INT  NOT NULL,
);
GO

/*--------------------------SE AGREGAN PK------------------------------*/

ALTER TABLE [DESCONOCIDOS4].PERSONA ADD CONSTRAINT PK_PERSONA
PRIMARY KEY  (Persona_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].USUARIO ADD CONSTRAINT PK_USUARIO
PRIMARY KEY  (Usu_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].CHOFER ADD CONSTRAINT PK_CHOFER
PRIMARY KEY  (Chofer_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].CLIENTE ADD CONSTRAINT PK_CLIENTE
PRIMARY KEY  (Cliente_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].TURNO ADD CONSTRAINT PK_TURNO
PRIMARY KEY  (Turno_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].MODELO ADD CONSTRAINT PK_MODELO
PRIMARY KEY  (Modelo_id); 
GO

ALTER TABLE [DESCONOCIDOS4].MARCA ADD CONSTRAINT PK_MARCA
PRIMARY KEY  (Marca_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].MARCA_MODELO ADD CONSTRAINT PK_MARCA_MODELO
PRIMARY KEY  (Marca_Modelo_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].AUTO ADD CONSTRAINT PK_AUTO
PRIMARY KEY  (Auto_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].UNIDAD_DISPONIBLE ADD CONSTRAINT PK_UNIDAD_DISPONIBLE
PRIMARY KEY  (Uni_Dis_Auto,Uni_Dis_Chofer,Uni_Dis_Turno); 
GO

ALTER TABLE [DESCONOCIDOS4].VIAJE ADD CONSTRAINT PK_VIAJE
PRIMARY KEY  (Viaje_Nro); 
GO

ALTER TABLE [DESCONOCIDOS4].CABECERO_FACTURA ADD CONSTRAINT PK_CABECERO_FACTURA
PRIMARY KEY  (Cab_Fac_Nro); 
GO

ALTER TABLE [DESCONOCIDOS4].ITEM_FACTURA ADD CONSTRAINT PK_ITEM_FACTURA
PRIMARY KEY  (Item_Fac_Nro_Fac,Item_Fac_Item); 
GO

ALTER TABLE [DESCONOCIDOS4].CABECERO_RENDICION ADD CONSTRAINT PK_CABECERO_RENDICION
PRIMARY KEY  (Cab_Rend_Nro); 
GO

ALTER TABLE [DESCONOCIDOS4].ITEM_RENDICION ADD CONSTRAINT PK_ITEM_RENDICION
PRIMARY KEY  (Item_Rend_NroRend,Item_Rend_Pos); 
GO

ALTER TABLE [DESCONOCIDOS4].ROL ADD CONSTRAINT PK_ROL
PRIMARY KEY  (Rol_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].FUNCIONALIDAD ADD CONSTRAINT PK_FUNCIONALIDAD
PRIMARY KEY  (Func_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].RAMA_MENU ADD CONSTRAINT PK_RAMA_MENU
PRIMARY KEY  (Rama_Menu_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].HOJA_MENU ADD CONSTRAINT PK_HOJA_MENU
PRIMARY KEY  (Hoja_Menu_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].FUNCIONALIDADXROL ADD CONSTRAINT PK_FUNCIONALIDADXROL
PRIMARY KEY  (FuncRol_Rol_Id,FunRol_Func_Id); 
GO

/*--------------------------SE AGREGAN FK------------------------------*/

ALTER TABLE [DESCONOCIDOS4].CHOFER ADD CONSTRAINT FK_CHOFER_PERSONA
	FOREIGN KEY (Chofer_Per_Id) REFERENCES [DESCONOCIDOS4].PERSONA (Persona_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].CLIENTE ADD CONSTRAINT FK_CLIENTE_PERSONA
	FOREIGN KEY (Cliente_Per_Id) REFERENCES [DESCONOCIDOS4].PERSONA (Persona_Id); 
GO

ALTER TABLE [DESCONOCIDOS4].MARCA_MODELO ADD CONSTRAINT FK_MARCA_MODELO_MARCA
	FOREIGN KEY (Marca_Modelo_Marca) REFERENCES [DESCONOCIDOS4].MARCA (Marca_Id); 
GO
 
ALTER TABLE [DESCONOCIDOS4].MARCA_MODELO ADD CONSTRAINT FK_MARCA_MODELO_MODELO
	FOREIGN KEY (Marca_Modelo_Modelo) REFERENCES [DESCONOCIDOS4].MODELO (Modelo_Id); 
GO
 
ALTER TABLE [DESCONOCIDOS4].AUTO ADD CONSTRAINT FK_AUTO_MARCA_MODELO
	FOREIGN KEY (Auto_Marca_Modelo) REFERENCES [DESCONOCIDOS4].MARCA_MODELO (Marca_Modelo_Id); 
GO
 
ALTER TABLE [DESCONOCIDOS4].UNIDAD_DISPONIBLE ADD CONSTRAINT FK_UNIDAD_DISPONIBLE_AUTO
	FOREIGN KEY (Uni_Dis_Auto) REFERENCES [DESCONOCIDOS4].AUTO  (Auto_Id); 
GO  

ALTER TABLE [DESCONOCIDOS4].UNIDAD_DISPONIBLE ADD CONSTRAINT FK_UNIDAD_DISPONIBLE_CHOFER
	FOREIGN KEY (Uni_Dis_Chofer) REFERENCES [DESCONOCIDOS4].CHOFER  (Chofer_Id); 
GO  
 
ALTER TABLE [DESCONOCIDOS4].UNIDAD_DISPONIBLE ADD CONSTRAINT FK_UNIDAD_DISPONIBLE_TURNO
	FOREIGN KEY (Uni_Dis_Turno) REFERENCES [DESCONOCIDOS4].TURNO (Turno_Id); 
GO  

ALTER TABLE [DESCONOCIDOS4].VIAJE ADD CONSTRAINT FK_VIAJE_CHOFER
	FOREIGN KEY (Viaje_Chofer) REFERENCES [DESCONOCIDOS4].CHOFER (Chofer_Id); 
GO 

ALTER TABLE [DESCONOCIDOS4].VIAJE ADD CONSTRAINT FK_VIAJE_CLIENTE
	FOREIGN KEY (Viaje_Cliente) REFERENCES [DESCONOCIDOS4].CLIENTE (Cliente_Id); 
GO 

ALTER TABLE [DESCONOCIDOS4].VIAJE ADD CONSTRAINT FK_VIAJE_AUTO
	FOREIGN KEY (Viaje_Automovil) REFERENCES [DESCONOCIDOS4].AUTO (Auto_Id); 
GO 
 
ALTER TABLE [DESCONOCIDOS4].VIAJE ADD CONSTRAINT FK_VIAJE_TURNO
	FOREIGN KEY (Viaje_Turno) REFERENCES [DESCONOCIDOS4].TURNO (Turno_Id); 
GO  
 
ALTER TABLE [DESCONOCIDOS4].CABECERO_FACTURA ADD CONSTRAINT FK_CABECERO_FACTURA_CLIENTE
	FOREIGN KEY (Cab_Fac_Cliente) REFERENCES [DESCONOCIDOS4].CLIENTE (Cliente_Id); 
GO  

ALTER TABLE [DESCONOCIDOS4].ITEM_FACTURA ADD CONSTRAINT FK_ITEM_FACTURA_CABECERO_FACTURA
	FOREIGN KEY (Item_Fac_Nro_Fac) REFERENCES [DESCONOCIDOS4].CABECERO_FACTURA (Cab_Fac_Nro); 
GO 

ALTER TABLE [DESCONOCIDOS4].ITEM_FACTURA ADD CONSTRAINT FK_ITEM_FACTURA_VIAJE
	FOREIGN KEY (Item_Fac_Id_Viaje) REFERENCES [DESCONOCIDOS4].VIAJE (Viaje_Nro); 
GO 
 
ALTER TABLE [DESCONOCIDOS4].CABECERO_RENDICION ADD CONSTRAINT FK_CABECERO_RENDICION_TURNO
	FOREIGN KEY (Cab_Rend_Turno) REFERENCES [DESCONOCIDOS4].TURNO (Turno_Id); 
GO 

ALTER TABLE [DESCONOCIDOS4].CABECERO_RENDICION ADD CONSTRAINT FK_CABECERO_RENDICION_CHOFER
	FOREIGN KEY (Cab_Rend_Chofer) REFERENCES [DESCONOCIDOS4].CHOFER (Chofer_Id); 
GO
 
ALTER TABLE [DESCONOCIDOS4].ITEM_RENDICION ADD CONSTRAINT FK_ITEM_RENDICION_CABECERO_RENDICION
	FOREIGN KEY (Item_Rend_NroRend) REFERENCES [DESCONOCIDOS4].CABECERO_RENDICION (Cab_Rend_Nro); 
GO 

ALTER TABLE [DESCONOCIDOS4].ITEM_RENDICION ADD CONSTRAINT FK_ITEM_RENDICION_VIAJE
	FOREIGN KEY (Item_Rend_Viaje) REFERENCES [DESCONOCIDOS4].VIAJE (Viaje_Nro); 
GO 

ALTER TABLE [DESCONOCIDOS4].USUARIO_ROL ADD CONSTRAINT FK_USUARIO_ROL_USUARIO
	FOREIGN KEY (UsuRol_Usu_Id) REFERENCES [DESCONOCIDOS4].USUARIO (Usu_Id); 
GO 

ALTER TABLE [DESCONOCIDOS4].USUARIO_ROL ADD CONSTRAINT FK_USUARIO_ROL_ROL
	FOREIGN KEY (UsuRol_Rol_Id) REFERENCES [DESCONOCIDOS4].ROL (Rol_Id); 
GO 
 
ALTER TABLE [DESCONOCIDOS4].RAMA_MENU ADD CONSTRAINT FK_RAMA_MENU_RAMA_MENU
	FOREIGN KEY (Rama_Menu_Ascendente) REFERENCES [DESCONOCIDOS4].RAMA_MENU (Rama_Menu_Id); 
GO 

ALTER TABLE [DESCONOCIDOS4].HOJA_MENU ADD CONSTRAINT FK_HOJA_MENU_RAMA_MENU
	FOREIGN KEY (Hoja_Menu_Ascendente) REFERENCES [DESCONOCIDOS4].RAMA_MENU (Rama_Menu_Id); 
GO 

ALTER TABLE [DESCONOCIDOS4].HOJA_MENU ADD CONSTRAINT FK_HOJA_FUNCIONALIDAD
	FOREIGN KEY (Hoja_Menu_Funcion) REFERENCES [DESCONOCIDOS4].FUNCIONALIDAD (Func_Id); 
GO 

ALTER TABLE [DESCONOCIDOS4].FUNCIONALIDADXROL ADD CONSTRAINT FK_FUNCIONALIDADXROL_ROL
	FOREIGN KEY (FuncRol_Rol_Id) REFERENCES [DESCONOCIDOS4].ROL (Rol_Id); 
GO 

ALTER TABLE [DESCONOCIDOS4].FUNCIONALIDADXROL ADD CONSTRAINT FK_FUNCIONALIDADXROL_FUNCIONALIDAD
	FOREIGN KEY (FunRol_Func_Id) REFERENCES [DESCONOCIDOS4].FUNCIONALIDAD(Func_Id ) ; 
GO 
...
AS
 BEGIN
 DECLARE @RESUL BIT
  IF (SELECT COUNT(* )FROM [DESCONOCIDOS4].PERSONA WHERE Persona_Telefono=@TEL)>0
	 SET @RESUL=1
  ELSE 
	SET @RESUL=0
 RETURN @RESUL
...
BEGIN
   DECLARE @RESUL CHAR(2)	
   IF[DESCONOCIDOS4].FN_TURNO_DENTRO_24(@Hini,@Hfin)='SI' AND [DESCONOCIDOS4].FN_TURNO_RANGO_OK(@Hini,@Hfin)='1'
   SET @RESUL='SI'
   ELSE
   SET @RESUL='NO'
   RETURN @RESUL
...
AS BEGIN
 ...
 IF OBJECT_ID('[DESCONOCIDOS4].FN_EXISTE_PANTENTE','FN') IS NOT NULL
	DROP FUNCTION [DESCONOCIDOS4].FN_EXISTE_PATENTE;
GO
--BUSCA SI YA EXISTE LA PATENTE, DEVUELVE 1 SI LO ENCUENTRA 0 POR EL CONTRARIO
CREATE FUNCTION [DESCONOCIDOS4].FN_EXISTE_PATENTE(@PATENTE VARCHAR(10))
RETURNS  BIT 
AS
 BEGIN
 DECLARE @RESUL BIT
  IF (SELECT COUNT(* )FROM [DESCONOCIDOS4].AUTO WHERE AUTO.Auto_Patente=@PATENTE)>0
	 SET @RESUL=1
  ELSE 
	SET @RESUL=0
 RETURN @RESUL
...
GO
 ...
 IF OBJECT_ID('[DESCONOCIDOS4].FN_EXISTE_DNI','FN') IS NOT NULL
	DROP FUNCTION [DESCONOCIDOS4].FN_EXISTE_DNI;
GO

--BUSCA SI YA EXISTE LA DNI, DEVUELVE 1 SI LO ENCUENTRA 0 POR EL CONTRARIO
CREATE FUNCTION [DESCONOCIDOS4].FN_EXISTE_DNI(@DNI NUMERIC(18))
RETURNS BIT
AS
 BEGIN
 DECLARE @RESUL BIT
  IF (SELECT COUNT(* )FROM [DESCONOCIDOS4].PERSONA WHERE Persona_Dni=@DNI)>0
	 SET @RESUL=1
  ELSE 
	SET @RESUL=0
 RETURN @RESUL
...
IF OBJECT_ID('[DESCONOCIDOS4].FN_USU_X_CHOFER','FN') IS NOT NULL
	DROP FUNCTION [DESCONOCIDOS4].FN_USU_X_CHOFER;
GO
-- DEVUELVE EL ID DE USUARIO ENTRANDO POR EL ID DE CHOFER
CREATE FUNCTION [DESCONOCIDOS4].FN_USU_X_CHOFER(@ID_CHOFER INT)
RETURNS  INT
AS
BEGIN
	DECLARE @USU_ID INT
	SET @USU_ID = (SELECT Usu_Id  FROM DESCONOCIDOS4.USUARIO  LEFT JOIN DESCONOCIDOS4.PERSONA  ON Persona_Id = Usu_Per_Id 
	LEFT JOIN DESCONOCIDOS4.CHOFER  CH ON CH.Chofer_Per_Id=Persona_Id 
	WHERE ch.Chofer_Id = @ID_CHOFER)
RETURN @USU_ID
END
GO

IF OBJECT_ID('[DESCONOCIDOS4].FN_USU_X_CLIENTE','FN') IS NOT NULL
	DROP FUNCTION [DESCONOCIDOS4].FN_USU_X_CLIENTE;
GO
-- DEVUELVE EL ID DE USUARIO ENTRANDO POR EL ID DE CLIENTE
CREATE FUNCTION [DESCONOCIDOS4].FN_USU_X_CLIENTE(@ID_CLIENTE INT)
RETURNS  INT
AS
BEGIN
	DECLARE @USU_ID INT
	SET @USU_ID = (SELECT Usu_Id  FROM DESCONOCIDOS4.USUARIO  LEFT JOIN DESCONOCIDOS4.PERSONA  ON Persona_Id = Usu_Per_Id 
	LEFT JOIN DESCONOCIDOS4.CLIENTE  CL ON CL.Cliente_Per_ID=Persona_Id 
...
BEGIN TRANSACTION
	...
	INSERT INTO [DESCONOCIDOS4].FUNCIONALIDADXROL(FuncRol_Rol_Id,FunRol_Func_Id)
	SELECT Rol_Id,Func_Id FROM [DESCONOCIDOS4].ROL,[DESCONOCIDOS4].FUNCIONALIDAD WHERE Rol_Nombre='CHOFER'AND (Func_Id= 5 OR Func_Id=6)
	INSERT INTO [DESCONOCIDOS4].FUNCIONALIDADXROL(FuncRol_Rol_Id,FunRol_Func_Id)
	SELECT Rol_Id,Func_Id FROM [DESCONOCIDOS4].ROL,[DESCONOCIDOS4].FUNCIONALIDAD WHERE Rol_Nombre='CLIENTE'AND (Func_Id=2 OR Func_Id=3)
COMMIT;
GO
...
BEGIN TRANSACTION 
 ...
 SELECT  Usu_Nombre_Usuario AS NOM_USUARIO FROM DESCONOCIDOS4.USUARIO WHERE Usu_Per_Id = @PERSONA_ID
 COMMIT;
 GO
...
BEGIN TRANSACTION 
  ...
  UPDATE [DESCONOCIDOS4].USUARIO_ROL   SET UsuRol_Habilitado=0 WHERE UsuRol_Usu_Id =DESCONOCIDOS4.FN_USU_X_CLIENTE(@ID_CLI)
COMMIT;
GO
...
--Listado de funcionalidades disponibles
IF OBJECT_ID(N'[DESCONOCIDOS4].LISTAR_FUNCIONALIDADES',N'P')IS NOT NULL
	DROP PROCEDURE [DESCONOCIDOS4].LISTAR_FUNCIONALIDADES;
GO
CREATE PROCEDURE [DESCONOCIDOS4].LISTAR_FUNCIONALIDADES
AS 
BEGIN
	SELECT
	Func_Id [id],
...
-- Listado de Roles completo
IF OBJECT_ID(N'[DESCONOCIDOS4].LISTAR_ROLES_SIN_CONDI',N'P')IS NOT NULL
	DROP PROCEDURE [DESCONOCIDOS4].LISTAR_ROLES_SIN_CONDI;
GO
CREATE PROCEDURE [DESCONOCIDOS4].LISTAR_ROLES_SIN_CONDI
AS 
BEGIN
	SELECT
	Rol_Id [id],
...
IF OBJECT_ID(N'[DESCONOCIDOS4].LISTAR_ROLES_HABI',N'P')IS NOT NULL
	DROP PROCEDURE [DESCONOCIDOS4].LISTAR_ROLES_HABI;
GO
CREATE PROCEDURE [DESCONOCIDOS4].LISTAR_ROLES_HABI
AS 
BEGIN
	SELECT
	Rol_Id [id],
	Rol_Nombre [nombre]	
	FROM DESCONOCIDOS4.ROL WHERE Rol_Habilitado=1
END
GO

-- Listado de Funcionalidades por rol 
IF OBJECT_ID(N'[DESCONOCIDOS4].LISTAR_FUNC_X_ROL',N'P')IS NOT NULL
	DROP PROCEDURE [DESCONOCIDOS4].LISTAR_FUNC_X_ROL;
GO
CREATE PROCEDURE [DESCONOCIDOS4].LISTAR_FUNC_X_ROL
@ID_ROL INT
AS 
BEGIN
	SELECT
...
-- Listado de Funcionalidades por rol 
IF OBJECT_ID(N'[DESCONOCIDOS4].LISTAR_FUNC_X_ROL_HABI',N'P')IS NOT NULL
	DROP PROCEDURE [DESCONOCIDOS4].LISTAR_FUNC_X_ROL_HABI;
GO
CREATE PROCEDURE [DESCONOCIDOS4].LISTAR_FUNC_X_ROL_HABI
@ID_ROL INT
AS 
BEGIN
	SELECT
	...
	FROM DESCONOCIDOS4.ROL LEFT JOIN DESCONOCIDOS4.FUNCIONALIDADXROL  ON Rol_Id=FuncRol_Rol_Id 
	LEFT JOIN DESCONOCIDOS4.FUNCIONALIDAD ON FunRol_Func_Id = Func_Id
	WHERE Rol_Habilitado=1 AND Rol_Id= @ID_ROL
END
GO
...
-- Listado de Funcionalidades por rol funcion
IF OBJECT_ID(N'[DESCONOCIDOS4].FN_LISTAR_FUNC_X_ROL',N'TF')IS NOT NULL
	DROP FUNCTION [DESCONOCIDOS4].FN_LISTAR_FUNC_X_ROL;
GO
CREATE FUNCTION [DESCONOCIDOS4].FN_LISTAR_FUNC_X_ROL (@ID_ROL INT)
RETURNS 
@RESUL TABLE (
   Id   INT
   ) 
...
IF OBJECT_ID(N'[DESCONOCIDOS4].LISTA_A_INT',N'TF')IS NOT NULL
	DROP FUNCTION [DESCONOCIDOS4].LISTA_A_INT;
GO
CREATE FUNCTION [DESCONOCIDOS4].LISTA_A_INT (@LISTA VARCHAR(255))
RETURNS 
@TABLA_LISTA TABLE
(
    ITEM INT
...
AS
BEGIN
    DECLARE @ITEM VARCHAR (255), @POS INT

    SET @LISTA = LTRIM(RTRIM(@LISTA))+ ','
    SET @POS = CHARINDEX(',', @LISTA, 1)
    WHILE @POS > 0
    BEGIN
        SET @ITEM = LTRIM(RTRIM(LEFT(@LISTA, @POS - 1)))
        IF @ITEM <> ''
        BEGIN
            INSERT INTO @TABLA_LISTA (ITEM) 
            VALUES (CAST(@ITEM AS int))
        END
        SET @LISTA = RIGHT(@LISTA, LEN(@LISTA) - @POS)
        SET @POS = CHARINDEX(',', @LISTA, 1)
    END
    RETURN
END
GO
-- SE INSERTA NUEVO ROL
IF OBJECT_ID(N'[DESCONOCIDOS4].PRC_ALTA_ROL',N'P')IS NOT NULL
	DROP PROCEDURE [DESCONOCIDOS4].PRC_ALTA_ROL;
GO
CREATE PROCEDURE [DESCONOCIDOS4].PRC_ALTA_ROL
@ROL_NOMBRE VARCHAR(255),
@Lista_Func NVARCHAR(255)
AS 
BEGIN TRAN
	INSERT INTO DESCONOCIDOS4.ROL (Rol_Nombre,Rol_Habilitado)VALUES (@ROL_NOMBRE,1)
	INSERT INTO DESCONOCIDOS4.FUNCIONALIDADXROL (FuncRol_Rol_Id,FunRol_Func_Id)
	SELECT Rol_Id,Func_Id FROM DESCONOCIDOS4.ROL, DESCONOCIDOS4.FUNCIONALIDAD 
	WHERE Rol_Id=SCOPE_IDENTITY() AND  Func_Id IN( SELECT * FROM [DESCONOCIDOS4].LISTA_A_INT (@Lista_Func))
COMMIT
GO

-- SE MODIFICA ROL 
IF OBJECT_ID(N'[DESCONOCIDOS4].PRC_MODIFICA_ROL',N'P')IS NOT NULL
	DROP PROCEDURE [DESCONOCIDOS4].PRC_MODIFICA_ROL;
GO
CREATE PROCEDURE [DESCONOCIDOS4].PRC_MODIFICA_ROL
@Id_ROL INT,
@ROL_NOMBRE VARCHAR(255),
@Habi INT,
@Lista_Func_agregar NVARCHAR(255),
@Lista_Func_quitar NVARCHAR(255)
AS 
BEGIN TRAN
	UPDATE DESCONOCIDOS4.ROL SET Rol_Nombre=@ROL_NOMBRE,Rol_Habilitado= @Habi WHERE Rol_Id=@Id_ROL
	UPDATE DESCONOCIDOS4.USUARIO_ROL SET UsuRol_Habilitado = @Habi WHERE  UsuRol_Rol_Id=@Id_ROL
	INSERT INTO DESCONOCIDOS4.FUNCIONALIDADXROL (FuncRol_Rol_Id,FunRol_Func_Id)
	SELECT Rol_Id,Func_Id FROM DESCONOCIDOS4.ROL, DESCONOCIDOS4.FUNCIONALIDAD 
	WHERE Rol_Id=@Id_ROL AND  Func_Id IN( SELECT ITEM FROM [DESCONOCIDOS4].LISTA_A_INT (@Lista_Func_agregar) WHERE ITEM NOT IN (SELECT * FROM [DESCONOCIDOS4].FN_LISTAR_FUNC_X_ROL(@Id_ROL)))
	DELETE DESCONOCIDOS4.FUNCIONALIDADXROL WHERE FuncRol_Rol_Id=@Id_ROL AND FunRol_Func_Id IN( SELECT * FROM [DESCONOCIDOS4].LISTA_A_INT (@Lista_Func_quitar))
COMMIT
GO
-- SE DA DE BAJA ROL
IF OBJECT_ID(N'[DESCONOCIDOS4].PRC_BAJA_ROL',N'P')IS NOT NULL
	DROP PROCEDURE [DESCONOCIDOS4].PRC_BAJA_ROL;
GO
CREATE PROCEDURE [DESCONOCIDOS4].PRC_BAJA_ROL
@Id_ROL INT
AS 
BEGIN TRAN
	UPDATE DESCONOCIDOS4.ROL SET Rol_Habilitado= 0 WHERE Rol_Id=@Id_ROL
	UPDATE DESCONOCIDOS4.USUARIO_ROL SET UsuRol_Habilitado = 0 WHERE  UsuRol_Rol_Id=@Id_ROL	
COMMIT
GO
...
IF ((SELECT Cliente_Habilitado FROM DESCONOCIDOS4.CLIENTE WHERE Cliente_Id = @CLIENTE) = 1)
	BEGIN
		SELECT 
			CONVERT(DATE,MIN(Viaje_Fecha_Hora_Inicio)) AS [Inicio Facturacion],
			@FECHA_HASTA							   AS [Fin Facturacion],
			@CLIENTE								   AS [Cliente],
			SUM(Viaje_Importe)						   AS [Importe Total]
...
@RESUL TABLE (
   ...
   [Id Viaje]				INT,
   [Cliente]				INT,
   [Km Recorridos]			NUMERIC(18,2),
   [Importe Total]			NUMERIC (18,2),
   [Fecha Hora Inicio]		DATETIME,
   [Fecha Hora Fin]			DATETIME   
   ) 
AS BEGIN
INSERT INTO @RESUL	
SELECT
...
BEGIN TRANSACTION	
	...
	[Nro Viaje]								   AS Item_Fac_Item,
	[Id Viaje]								   AS Item_Fac_Id_Viaje
...
SET @MONTO_A_RENDIR = (SELECT SUM(Viaje_Importe*0.3) FROM DESCONOCIDOS4.VIAJE
...
IF (@HABILITADO = 1 AND @TURNO IN (SELECT * FROM @TURNOS_CHOFER))--fin validacion
	BEGIN
		SELECT 
			@FECHA_RENDICION		AS [Fecha Rendicion],
			Viaje_Chofer			AS [Chofer],
...
--COMPRUEBA QUE NO SE HAYA RENDIDO ESE DIA 
IF OBJECT_ID(N'[DESCONOCIDOS4].FN_DIA_RENDIDO',N'FN')IS NOT NULL
	DROP FUNCTION [DESCONOCIDOS4].FN_DIA_RENDIDO;
GO

CREATE FUNCTION [DESCONOCIDOS4].FN_DIA_RENDIDO(@CHOFER INT , @FECHA_RENDICION DATE)
RETURNS BIT
AS
BEGIN
	DECLARE @RESUL BIT
	IF (SELECT COUNT(*) FROM [DESCONOCIDOS4].CABECERO_RENDICION WHERE Cab_Rend_Chofer=@CHOFER AND Cab_Rend_Fecha=@FECHA_RENDICION)>0 
	SET @RESUL=1
	ELSE 
	SET @RESUL=0
	RETURN @RESUL
...
AS BEGIN
	INSERT INTO @RESUL
	SELECT
	ROW_NUMBER()			OVER ( ORDER BY  Viaje_Nro) AS ITEM,
	Viaje_Nro				AS  ID_VIAJE,
	Viaje_Cliente			AS CLIENTE,
	Viaje_Cantidad_Km		AS CANTIDAD_KM,
...
BEGIN TRANSACTION
	  INSERT INTO [DESCONOCIDOS4].CABECERO_RENDICION(Cab_Rend_Nro,Cab_Rend_Turno,Cab_Rend_Chofer,Cab_Rend_Fecha,Cab_Rend_Importe) 
	      VALUES(
		   (SELECT MAX(Cab_Rend_Nro)  +1 FROM DESCONOCIDOS4.CABECERO_RENDICION)	,
		   @TURNO,
		   @CHOFER,
		   @FECHA_RENDICION	,
...
BEGIN TRANSACTION
	...
	[Nro Rendicion]							  AS Item_Rend_Pos,
	[Id Viaje]							      AS Item_Rend_Viaje

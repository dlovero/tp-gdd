...
select * from DESCONOCIDOS4.USUARIO_ROL join DESCONOCIDOS4.USUARIO on Usu_Id=UsuRol_Usu_Id where UsuRol_Rol_Id=2
	go
	select * from DESCONOCIDOS4.CHOFER where Chofer_Per_Id=47

select * from DESCONOCIDOS4.CHOFER
select * from DESCONOCIDOS4.ROL
SELECT * FROM DESCONOCIDOS4.USUARIO_ROL ORDER BY UsuRol_Usu_Id

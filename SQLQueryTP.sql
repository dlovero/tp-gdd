...
Cliente_Per_Id INT REFERENCES [DESCONOCIDOS4].USUARIO NOT NULL,
...
Chofer_Per_Id INT REFERENCES [DESCONOCIDOS4].USUARIO NOT NULL,
...
--REFERENCES [DESCONOCIDOS4].CABECERO_FACTURA(Cab_Fac_Nro)
GO
